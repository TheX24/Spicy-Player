...
import com.tx24.spicyplayer.uiLibrary.albums.ui.albumdetail.AlbumDetailsScreen
import com.tx24.spicyplayer.uiLibrary.albums.ui.albumsscreen.AlbumsScreen
...
fun NavGraphBuilder.albumsGraph(
    ...
    navigation(
        ...
        composable(
            ...
            deepLinks = listOf(
                navDeepLink { uriPattern = "spicyplayer://albums/{${AlbumDetailsViewModel.ALBUM_ID_KEY}}" }
            )
        )
        {
            AlbumDetailsScreen(
