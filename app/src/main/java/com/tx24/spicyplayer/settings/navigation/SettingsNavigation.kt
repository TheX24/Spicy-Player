package com.tx24.spicyplayer.settings.navigation
...
fun NavGraphBuilder.settingsGraph(
    ...
    navigation(
        ...
        composable(
            ...
            val viewModel: SettingsViewModel = hiltViewModel()
            val state by viewModel.state.collectAsState()
            val userPreferences = (state as? com.tx24.spicyplayer.settings.SettingsState.Loaded)?.userPreferences ?: UserPreferencesUi()
            ResetSettingsScreen(
