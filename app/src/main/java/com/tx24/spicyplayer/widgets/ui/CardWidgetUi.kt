...
import com.tx24.spicyplayer.widgets.NextSongAction
import com.tx24.spicyplayer.widgets.PreviousSongAction
import com.tx24.spicyplayer.R
import com.tx24.spicyplayer.widgets.TogglePlaybackAction
...
fun CardWidgetUi(
    ...
    Row(
        modifier = GlanceModifier.fillMaxWidth().height(100.dp).background(Color.White)
            .clickable(actionStartActivity(ComponentName(context, "com.tx24.spicyplayer.MainActivity"))),
